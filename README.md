...
Controls: **WASD** move · **mouse** aim (your Ranger and bow now FACE where you aim) · auto-fire is ON
(**T** toggles, remembered) · **SPACE** volley ability — or, near a chest, **SPACE opens it** ·
...
stash survives death, drunk pots + equipped gear die with the character) → permadeath → graveyard (**G**).
**Diablo-style HP/MP orbs** flank the action bar. M1 gave it feel: chiptune SFX + volume, hitstop,
particles, pause menu, fullscreen. Your account only moves forward.

## 📁 What's in this folder

| Path | What it is |
|------|-----------|
| `game/` | The game. `index.html` + `js/` (data, save, audio, sim, maps, textures, entities, scenes, builder, main) |
...
| `docs/MILESTONES.md` | **The tracker.** M0–M6 with checkboxes and exit gates. M0–M1 ✅ · M2/M2.1 features in (human gates pending) · M3 nearly complete (map builder + equipment + vault + affix v2 landed) |
...
**vault** (8 slots, survives death), and the full **affix engine** all shipped; left in M3: Q3/Q5
experiment flags + the first CC0 art batch. 1.0 = **M6** (3 classes, 3 biomes, 2 dungeons, 5 bosses,
