...
| M5 | Content ramp | 🔨 2026-07-15 | FUN GATE 2: 3 testers, median session ≥30 min, a death that causes "one more run" | IN PROGRESS — biome 2 THE GROVE (M5.0) + biome 3 THE GRAVEYARD (M5.6) SHIPPED · **M5.7 biome 4 THE ROBOTICS FACTORY: design + all assets LOCKED 2026-07-15 (docs/MAP4_PLAN.md + docs/FACTORY_BOSS.md), BUILD PENDING** · legendary kits / progression rework / collection also shipped. Gate itself still needs the 3-tester playtest |
| M5.9 | 16-MAP CAMPAIGN design (realms 5–20) | ✅ 2026-07-17 | All 16 map folders stocked: PLAN.md + BUILD_INSTRUCTIONS.md + approved assets + render scripts, artdev mirrors, close-out docs | PASSED — 16/16 design-complete (skyisles pyramid castle lunar pirate crystal carnival swamp west colosseum abyss sugar neon viceversa prehistoria belly); every pick Red's; Opus BUILD pending per docs/NEXT_SESSION.md |
| M7 | 16-MAP CAMPAIGN build (realms 5–20) | 🔨 2026-07-17 | Registry refactor + all 16 maps built, each suite + full battery green | IN PROGRESS — M7a REGISTRY REFACTOR shipped (battery green, suites de-drifted) · 1/16 STORM SKY ISLES ?v=m7b (m7 26/26) · 2/16 PYRAMID PLUNDER ?v=m7c (m8 23/23, first registry TWO-PHASE boss via def.transform) · 3/16 VAMPIRE CASTLE ?v=m7d (m9 21/21, BLOOD MOON COURT, gate-smash arrival) · 4/16 LUNAR STATION ?v=m7e (m10 28/28, LOW GRAVITY, lights-out Overmind) · 5/16 PIRATE SHIP ?v=m7f (m11 27/27, ROCKING DECK, ghost-ship broadside) · 6/16 CRYSTAL CAVERNS ?v=m7g (m12 26/26, GROWING CRYSTAL gates, RAINBOW CORE Shardlord) · 7/16 HAUNTED CARNIVAL ?v=m7h (m13 33/33 + full battery green — GAME BOOTHS, trapeze RINGMASTER) · **8/16 WITCH'S SWAMP ?v=m7i (m14_swamp_verify 34/34 + m2/m13 smoke green — HEX TOTEMS, cauldron-rise BREWMISTRESS, WISP RAVE trance; ⚠ full battery on m7i pending next session)** |
