...
(function (root) {
  ...
  var SUGAR_ART = {
    ...
    buildInto: function (ctx) {
      ...
      ctx.MOB_HI.gummyBear = 'sugGummyHi';       ctx.MOB_DISPLAY.gummyBear = 42;
      ctx.MOB_HI.gingerdead = 'sugGingerHi';     ctx.MOB_DISPLAY.gingerdead = 48;
      ctx.MOB_HI.gingerHalf = 'sugGingerHalfHi'; ctx.MOB_DISPLAY.gingerHalf = 34;
      ctx.MOB_HI.candyLancer = 'sugLancerHi';    ctx.MOB_DISPLAY.candyLancer = 50;
      ctx.MOB_HI.jawbreaker = 'sugJawHi';        ctx.MOB_DISPLAY.jawbreaker = 48;
      ctx.MOB_HI.lolliTwirler = 'sugTwirlerHi';  ctx.MOB_DISPLAY.lolliTwirler = 52;
      ctx.MOB_HI.gumdrop = 'sugGumdropHi';       ctx.MOB_DISPLAY.gumdrop = 44;
      ctx.MOB_HI.gumdropMini = 'sugGumdropMiniHi'; ctx.MOB_DISPLAY.gumdropMini = 30;
      ctx.MOB_HI.cottonDrift = 'sugCottonHi';    ctx.MOB_DISPLAY.cottonDrift = 50;
      ctx.MOB_HI.mintGuardian = 'sugMintHi';     ctx.MOB_DISPLAY.mintGuardian = 52;
      ctx.MOB_HI.mallowBrute = 'sugMallowHi';    ctx.MOB_DISPLAY.mallowBrute = 60;
      ctx.MOB_HI.mallowMini = 'sugMallowMiniHi'; ctx.MOB_DISPLAY.mallowMini = 42;
      ctx.MOB_HI.cupcakeMimic = 'sugMimicHi';    ctx.MOB_DISPLAY.cupcakeMimic = 48;
      ctx.MOB_HI.candyCorn = 'sugCornHi';        ctx.MOB_DISPLAY.candyCorn = 38;
