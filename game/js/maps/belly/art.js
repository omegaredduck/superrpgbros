...
(function (root) {
  ...
  var BELLY_ART = {
    ...
    buildInto: function (ctx) {
      ...
      ctx.MOB_HI.drownedFisherman = 'bellyFishermanHi'; ctx.MOB_DISPLAY.drownedFisherman = 52;
      ctx.MOB_HI.gutLobster = 'bellyLobsterHi';         ctx.MOB_DISPLAY.gutLobster = 54;
      ctx.MOB_HI.seaSnake = 'bellySeaSnakeHi';          ctx.MOB_DISPLAY.seaSnake = 50;
      ctx.MOB_HI.bellyStarfish = 'bellyStarfishHi';   ctx.MOB_DISPLAY.bellyStarfish = 44;
      ctx.MOB_HI.mermaid = 'bellyMermaidHi';            ctx.MOB_DISPLAY.mermaid = 52;
      ctx.MOB_HI.swallowedPirate = 'bellyPirateHi';     ctx.MOB_DISPLAY.swallowedPirate = 52;
      ctx.MOB_HI.skeletonDeckhand = 'bellyDeckhandHi';  ctx.MOB_DISPLAY.skeletonDeckhand = 50;
      ctx.MOB_HI.shipRatPack = 'bellyRatsHi';           ctx.MOB_DISPLAY.shipRatPack = 38;
      ctx.MOB_HI.bilgeParrot = 'bellyParrotHi';         ctx.MOB_DISPLAY.bilgeParrot = 42;
      ctx.MOB_HI.gutCrab = 'bellyCrabHi';               ctx.MOB_DISPLAY.gutCrab = 52;
      ctx.MOB_HI.acidSlug = 'bellySlugHi';              ctx.MOB_DISPLAY.acidSlug = 48;
      ctx.MOB_HI.bileJelly = 'bellyJellyHi';            ctx.MOB_DISPLAY.bileJelly = 46;
      ctx.MOB_HI.lamprey = 'bellyLampreyHi';            ctx.MOB_DISPLAY.lamprey = 48;
      ctx.MOB_HI.gutWorm = 'bellyWormHi';               ctx.MOB_DISPLAY.gutWorm = 54;
      ctx.MOB_HI.krillCloud = 'bellyKrillHi';           ctx.MOB_DISPLAY.krillCloud = 50;
      ctx.MOB_HI.fleshPolyp = 'bellyPolypHi';           ctx.MOB_DISPLAY.fleshPolyp = 50;
