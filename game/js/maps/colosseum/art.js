...
(function (root) {
  ...
  var COL_ART = {
    ...
    buildInto: function (ctx) {
      ...
      ctx.MOB_HI.gladiator = 'colGladiatorHi';           ctx.MOB_DISPLAY.gladiator = 109;
      ctx.MOB_HI.retiarius = 'colRetiariusHi';           ctx.MOB_DISPLAY.retiarius = 109;
      ctx.MOB_HI.warLion = 'colLionHi';                  ctx.MOB_DISPLAY.warLion = 118;
      ctx.MOB_HI.shieldLegionary = 'colLegionaryHi';     ctx.MOB_DISPLAY.shieldLegionary = 113;
      ctx.MOB_HI.beastHandler = 'colHandlerHi';          ctx.MOB_DISPLAY.beastHandler = 105;
      ctx.MOB_HI.warElephant = 'colElephantHi';          ctx.MOB_DISPLAY.warElephant = 151;
      ctx.MOB_HI.minotaur = 'colMinotaurHi';             ctx.MOB_DISPLAY.minotaur = 126;
      ctx.MOB_HI.crowdFavorite = 'colFavoriteHi';        ctx.MOB_DISPLAY.crowdFavorite = 109;
      ctx.MOB_HI.warHound = 'colHoundHi';                ctx.MOB_DISPLAY.warHound = 97;
      ctx.MOB_HI.vestalCurser = 'colVestalHi';           ctx.MOB_DISPLAY.vestalCurser = 105;
      ctx.MOB_HI.executioner = 'colExecutionerHi';       ctx.MOB_DISPLAY.executioner = 126;
      ctx.MOB_HI.chariotRacer = 'colChariotHi';          ctx.MOB_DISPLAY.chariotRacer = 134;
