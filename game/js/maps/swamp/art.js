...
(function (root) {
  ...
  var SW_ART = {
    ...
    buildInto: function (ctx) {
      ...
      ctx.MOB_HI.bogling = 'boglingHi';                 ctx.MOB_DISPLAY.bogling = 88;
      ctx.MOB_HI.giantLeech = 'giantLeechHi';           ctx.MOB_DISPLAY.giantLeech = 101;
      ctx.MOB_HI.skeeterCloud = 'skeeterCloudHi';       ctx.MOB_DISPLAY.skeeterCloud = 105;
      ctx.MOB_HI.snapjawTurtle = 'snapjawTurtleHi';     ctx.MOB_DISPLAY.snapjawTurtle = 113;
      ctx.MOB_HI.witchling = 'witchlingHi';             ctx.MOB_DISPLAY.witchling = 101;
      ctx.MOB_HI.sporecapMyconid = 'sporecapMyconidHi'; ctx.MOB_DISPLAY.sporecapMyconid = 109;
      ctx.MOB_HI.toadAlchemist = 'toadAlchemistHi';     ctx.MOB_DISPLAY.toadAlchemist = 113;
      ctx.MOB_HI.mireSerpent = 'mireSerpentHi';         ctx.MOB_DISPLAY.mireSerpent = 118;
      ctx.MOB_HI.glowcapSprite = 'glowcapSpriteHi';     ctx.MOB_DISPLAY.glowcapSprite = 84;
      ctx.MOB_HI.bottledImp = 'bottledImpHi';           ctx.MOB_DISPLAY.bottledImp = 97;
      ctx.MOB_HI.cauldronMimic = 'cauldronMimicHi';     ctx.MOB_DISPLAY.cauldronMimic = 122;
      ctx.MOB_HI.mossback = 'mossbackHi';               ctx.MOB_DISPLAY.mossback = 134;
